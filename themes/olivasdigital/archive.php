            ...
            <div id="OD-column1">
                ...
                ?>
                    <form method="get">
                        ...
                        <button class='btn btn-outline-secondary mt-2 mb-2' type='submit' class='fs-5'><?php echo esc_html($term->slug) ?></button>
                    </form>
                <?php
                }
                if (isset($_GET['categoria'])) {
                ...
                <?php
                    ...
                    ?>    
                        <div class="clearfix-20" style="padding:20px"> </div>
                    <?php
                }
                ?>
            </div>
